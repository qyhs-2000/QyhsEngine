...
namespace qyhs
{
	...
	namespace Reflection
	{
		...
		{
			class TypeTmpTestClassOperator
			{
			public:
				//class
				//static void getTmpTestClassBaseClassReflectionInstanceList()
				static const char* getClassName(){return "TmpTestClass";}
				static void* constructorWithJson(const Json & json_context)
				{
					TmpTestClass * ret_instance = new TmpTestClass;
					Serializer::read(json_context,*ret_instance);
					return ret_instance;
				}
				static int getTmpTestClassBaseClassReflectionInstanceList(ReflectionInstance* &out_list, void* instance)
				{
					int count = 0;
				...
				{
					return Serializer::write(*(TmpTestClass*)instance_ptr);
				}
				//field
		...
		void TypeWrapperRegister_TmpTestClass()
		{
		
		
		
		ClassFunctionTuple * f_class_function_tuple_TmpTestClass = new ClassFunctionTuple(
            &TypeFieldReflectionOperator::TypeTmpTestClassOperator::constructorWithJson,
            &TypeFieldReflectionOperator::TypeTmpTestClassOperator::getTmpTestClassBaseClassReflectionInstanceList,
            &TypeFieldReflectionOperator::TypeTmpTestClassOperator::writeByName
		);
		REGISTER_TO_CLASS_MAP("TmpTestClass",f_class_function_tuple_TmpTestClass);
		}
		...
		{
			void TmpTestClass(){TypeWrapperRegister_TmpTestClass();}
